...
final class LeagueViewModel: ObservableObject {
    ...
    func getLeague() {
        ...
        guard let url = URL(string: "https://raw.githubusercontent.com/ihernandez812/PixProBaseballStats/refs/heads/ADD_2024_SEASON/pix_pro_stats/src/seasons/league.json") else{
            print("Invalid URL")
            return
        }
